...
- (NSMutableArray *)pareseTimelineResponseObject:(id)object params:(NSString *)key {
    NSMutableArray *statuses = nil;
    if ([object isKindOfClass:[NSDictionary class]]) {
        NSDictionary *dic = (NSDictionary *)object;
        NSArray *statusesArray = [dic arrayValueForKey:key];
        if (statusesArray) {
    ...
    WeiboRequestOperation *operation =
        [[WeiboRequest shared] getFromPath:path
             ...
             if (error) {
                 ...
                 NSMutableArray *statuses = [self pareseTimelineResponseObject:result params:key];
                 if (statuses) {
...
- (WeiboRequestOperation *)queryPublicTimelineWithCount:(int)count
    ...
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   ...
                                   , nil];
    return [self queryTimelineWithPath:@"statuses/public_timeline.json" params:params opt_key:@"statuses" completed:completedBlock];
}
...
- (WeiboRequestOperation *)queryTimeline:(StatusTimeline)timeline
    ...
    return [self queryTimelineWithPath:queryPath params:params opt_key:@"statuses" completed:completedBlock];
}
...
- (WeiboRequestOperation *)queryFavorites:(int)count
    ...
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   ...
                                   [NSString stringWithFormat:@"%d", count], @"count"
                                   , nil];
    return [self queryTimelineWithPath:@"favorites.json" params:params opt_key:@"favorites" completed:completedBlock];
}
