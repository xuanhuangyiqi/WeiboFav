...
- (id)initWithJsonDictionary:(NSDictionary*)dic
{
	self = [super init];
    if (self) {
        self.statusIdString = [[dic dictionaryValueForKey:@"status"] stringValueForKey:@"id"];
        self.createdAt = [[dic dictionaryValueForKey:@"status"] timeValueForKey:@"created_at"];
        self.statusId = [[dic dictionaryValueForKey:@"status"]  longLongValueForKey:@"id"];
        self.text = [[dic dictionaryValueForKey:@"status"]  stringValueForKey:@"text"];
        self.favorited = [[dic  dictionaryValueForKey:@"status"] boolValueForKey:@"favorited"];
        self.truncated = [[dic  dictionaryValueForKey:@"status"] boolValueForKey:@"truncated"];
        self.inReplyToStatusId = [[dic  dictionaryValueForKey:@"status"] longLongValueForKey:@"in_reply_to_status_id"];
        self.inReplyToUserId = [[dic  dictionaryValueForKey:@"status"] longLongValueForKey:@"in_reply_to_user_id"];
        self.inReplyToScreenName = [[dic  dictionaryValueForKey:@"status"] stringValueForKey:@"in_reply_to_screen_name"];
        self.mid = [[dic dictionaryValueForKey:@"status"]  longLongValueForKey:@"mid"];
        ...
        NSDictionary *retweetedStatusDic = [[dic dictionaryValueForKey:@"status"]dictionaryValueForKey:@"retweeted_status"];
        if (retweetedStatusDic) {
            self.retweet = [retweetedStatusDic objectForKey:@"text"];
